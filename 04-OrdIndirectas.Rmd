...
Es sencillo de interpretar ya que las distancias entre las muestras son interpretadas directamente como distancias euclidianas.
...
La proyección de las distancias euclidias en un plano puede distorsionar algunas distancias en otros planos.

__*Principal Coordinates Análisis (PCoA)*__ 

Fortalezas

Es una extensión del PCA, permite una definición más amplia de las disimilitudes entre muestras que la distancia Euclidia.

Es capaz de convertir otras medidas de disimilitud (además de la euclidia) en distancias entre muestras.
...
Fortalezas
Corrige el “Efecto arco” del CA, realizando una ordenación por segmentos y se realinean los segmentos para evitar la curvatura 
